import jsonSchemaTraverse, { Callback as TraverseCallback } from 'json-schema-traverse';
...
export function createFromXdl(sdkVersion: string, xdlSchema: JsonSchema): ManifestSchema {
  ...
  const traverser: TraverseCallback = (
    ...
    mutateSchemaBareWorkflowDescription(nested);
    mutateSchemaMarkdownDescription(nested);
  };
...
/**
 * Remove all properties that are auto-generated by the system.
 * These properties should not be presented to the user.
 */
export function mutateSchemaAutoGenerated(
  nested: JsonSchema,
  parent?: JsonSchema,
  parentKey?: string,
  parentKeyIndex?: string | number
) {
  // Only edit the children nodes which are autogenerated
